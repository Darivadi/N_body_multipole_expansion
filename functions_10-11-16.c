  ...
  for(i=0; i<NPARTS; i++)
    {
      ...
      part[i].quadrupole[X] = 0.0;
      part[i].quadrupole[Y] = 0.0;
      part[i].quadrupole[Z] = 0.0;
...
{  
  ...
  gp[n].pos_cm[X] += GV.mass * part[indexPartArray].pos[X];
  gp[n].pos_cm[Y] += GV.mass * part[indexPartArray].pos[Y]; 
  gp[n].pos_cm[Z] += GV.mass * part[indexPartArray].pos[Z]; 
...
int pc_force_mono_dip(int m, int n)
{
  ...
  */
  ...
  part[m].dipole[X] += aux_factor * gp[n].mass_pos[X];

  part[m].acc[X] += -3.0 * aux_pos[X] * aux_pos[Y] * dist5 * gp[n].mass_pos[Y];
  part[m].dipole[X] += -3.0 * aux_pos[X] * aux_pos[Y] * dist5 * gp[n].mass_pos[Y];
  
  part[m].acc[X] += -3.0 * aux_pos[X] * aux_pos[Z] * dist5 * gp[n].mass_pos[Z];
  part[m].dipole[X] += -3.0 * aux_pos[X] * aux_pos[Z] * dist5 * gp[n].mass_pos[Z];
  ...
  */
  ...
  part[m].dipole[Y] += aux_factor * gp[n].mass_pos[Y];

  part[m].acc[Y] += -3.0 * aux_pos[X] * aux_pos[Y] * dist5 * gp[n].mass_pos[X];
  part[m].dipole[Y] += -3.0 * aux_pos[X] * aux_pos[Y] * dist5 * gp[n].mass_pos[X];

  part[m].acc[Y] += -3.0 * aux_pos[Y] * aux_pos[Z] * dist5 * gp[n].mass_pos[Z];
  part[m].dipole[Y] += -3.0 * aux_pos[Y] * aux_pos[Z] * dist5 * gp[n].mass_pos[Z];
  ...
  */
  ...
  part[m].dipole[Z] += aux_factor * gp[n].mass_pos[Z];

  part[m].acc[Z] += -3.0 * aux_pos[X] * aux_pos[Z] * dist5 * gp[n].mass_pos[X];
  part[m].dipole[Z] += -3.0 * aux_pos[X] * aux_pos[Z] * dist5 * gp[n].mass_pos[X];

  part[m].acc[Z] += -3.0 * aux_pos[Y] * aux_pos[Z] * dist5 * gp[n].mass_pos[Y];
  part[m].dipole[Z] += -3.0 * aux_pos[Y] * aux_pos[Z] * dist5 * gp[n].mass_pos[Y];
...
int pc_force_mono_dip_quad(int m, int n)
{
  ...
  */
  ...
  part[m].quadrupole[Z] += -0.5 * aux_factor * gp[n].mass_pos2[X];

  aux_factor = 15.0 * POW2(aux_pos[Y]) * aux_pos[Z] * dist7;
  aux_factor += -3.0 * aux_pos[Z] * dist5;
  part[m].acc[Z] += -0.5 * aux_factor * gp[n].mass_pos2[Y];
  part[m].quadrupole[Z] += -0.5 * aux_factor * gp[n].mass_pos2[Y];

  aux_factor     = 15.0 * POW3( aux_pos[Z] ) * dist7;
  aux_factor     += -9.0 * aux_pos[Z] * dist5;
  part[m].acc[Z] += -0.5 * aux_factor * gp[n].mass_pos2[Z]; 
  part[m].quadrupole[Z] += -0.5 * aux_factor * gp[n].mass_pos2[Z]; 
  
  part[m].acc[Z] += -15.0 * aux_pos[X] * aux_pos[Y] * aux_pos[Z] * dist7 * gp[n].mass_posxy;
  part[m].quadrupole[Z] += -15.0 * aux_pos[X] * aux_pos[Y] * aux_pos[Z] * dist7 * gp[n].mass_posxy;

  aux_factor = 15.0 * aux_pos[Y] * POW2(aux_pos[Z]) * dist7;
  aux_factor += -3.0 * aux_pos[Y] * dist5;
  part[m].acc[Z] += -1.0 * aux_factor * gp[n].mass_posyz;
  part[m].quadrupole[Z] += -1.0 * aux_factor * gp[n].mass_posyz;
  
  aux_factor = 15.0 * aux_pos[X] * POW2(aux_pos[Z]) * dist7;
  aux_factor += -3.0 * aux_pos[X] * dist5;
  part[m].acc[Z] += -1.0 * aux_factor * gp[n].mass_posxz;
  part[m].quadrupole[Z] += -1.0 * aux_factor * gp[n].mass_posxz;
